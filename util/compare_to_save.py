            ...
            if add_new_note is not None:
                ...
                save_content = '这是依据%s标准进行保存的' \
                               ...
                               (compare_target, str(opt), str(train_log['epoch']),
                                ...
                                str(train_log['train_F1_T']), str(train_log['train_P_T']),
                                str(train_log['train_R_T']), str(train_log['train_F1_F']),
                                str(train_log['train_P_F']),str(train_log['train_R_F']),
                                str(dev_log['dev_loss']), str(dev_log['dev_accuracy']),
                                str(dev_log['dev_F1_T']), str(dev_log['dev_P_T']),
                                str(dev_log['dev_R_T']), str(dev_log['dev_F1_F']),
                                str(dev_log['dev_P_F']), str(dev_log['dev_R_F']))
